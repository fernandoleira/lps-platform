...
class ApiKey(db.Model):
    ...
    user_id = Column('user_id', VARCHAR(36),
    ...
    def __init__(self, user_id, api_key=None, created_at=None, updated_at=None):
        ...
        self.expired_at = self._get_expiration_timestamp(
...
class Unit(db.Model):
    ...
    unit_id = Column('unit_id', VARCHAR(36), primary_key=True)
    ...
    def __init__(self, name, user_id, alert_mail, alert_sms, unit_id=None):
        self.unit_id = unit_id if unit_id is not None else str(uuid.uuid4())
        self.name = name
